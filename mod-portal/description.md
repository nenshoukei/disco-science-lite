...
Heavily optimized to keep UPS (Updates Per Second) impact minimal, even with large numbers of labs. Additional performance tuning options are available in mod settings.
