...
All image files under `graphics/` are auto-generated by the script: [tasks/graphics/update-graphics.py](update-graphics.py). It can be executed by `make graphics`.

To generate these images, you have to install:

- `python` with Anaconda
    - Required packgages can be installed with `pip install -r requirements.txt`
- Factorio
- Space-Age DLC
