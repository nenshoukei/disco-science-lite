...
describe("mods/bobsmods", function ()
  ...
  describe("on_data_final_fixes", function ()
    ...
    it("removes light layer and freezes bob-lab-2", function ()
    ...
    it("freezes bob-burner-lab without removing any layer", function ()
      ...
      assert.are.equal("__bobtech__/graphics/entity/lab/burner-lab.png", on_animation_burner.layers[1].filename)
      assert.are.equal("__bobtech__/graphics/entity/lab/lab-integration.png", on_animation_lab2.layers[2].filename)
      assert.are.equal("__bobtech__/graphics/entity/lab/lab-shadow.png", on_animation_lab2.layers[3].filename)
      Helper.assert_animation.frozen(1, on_animation_burner)
    end)

    it("removes light layer and freezes bob-lab-alien", function ()
      Mod.on_data_final_fixes()
