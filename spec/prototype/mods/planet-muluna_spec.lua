  ...
  describe("on_data_final_fixes", function ()
    ...
    it("removes emission layer and creates overlay and companion", function ()
      ...
      Helper.assert_animation.has_layers({
        "__muluna-graphics__/graphics/photometric-lab/photometric-lab-hr-shadow.png",
        "__muluna-graphics__/graphics/photometric-lab/photometric-lab-hr-animation-1.png",
      }, on_animation)
