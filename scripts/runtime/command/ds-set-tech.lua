...
local function search_tech_by_name(player, tech_name, callback)
  ...
  if not technologies then return callback(nil) end
...
commands.add_command("ds-set-tech", "Set the current research technology. Usage: /ds-set-tech tech-name", function (event)
