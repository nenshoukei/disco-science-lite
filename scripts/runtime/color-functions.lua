...
--- - `scale`    - Spatial variation scale. Precomputed as `(1 + n_colors / n_visible_labs) / 8` by the caller.
---                Amplifies color variation when labs are few; converges to 1/8 as labs increase.
