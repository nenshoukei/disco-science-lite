...
local consts = {
  ...
  --- State update period in ticks
  STATE_UPDATE_INTERVAL = 30,
  --- Maximum auto-adjusted color update stride
  MAX_COLOR_UPDATE_STRIDE = 60,
  --- Maximum auto-adjusted color update interval in ticks
  MAX_COLOR_UPDATE_INTERVAL = 30,
